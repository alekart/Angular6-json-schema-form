...
Run `ng generate component component-name --project @alekart/ajsf-bootstrap3` to generate a new component. You can also use `ng generate directive|pipe|service|class|guard|interface|enum|module --project @ajsf/bootstrap3`.
